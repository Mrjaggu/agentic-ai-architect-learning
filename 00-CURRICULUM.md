...
*Source reading: Shingde, "System Design for Agent Systems (Part 1)," AI That Ships.*
...
| # | Chapter | Status | Chapter file |
|---|---|---|---|
| 1 | Evolution of AI Systems | drafted v1 | ch01-evolution.md |
| 2 | Anatomy of an AI Agent | drafted v1 | ch02-agent-anatomy.md |
| 3 | Agent Design Patterns | drafted v1 | ch03-design-patterns.md |
| 4 | Agent Graphs & State Machines | drafted v1 | ch04-agent-graphs.md |
| 5 | Agent Harness Engineering | drafted v1 | ch05-agent-harness.md |
| 6 | Backend & System Design for Agent Services | drafted v1 | ch06-agent-backend.md |
| 7 | Deploying Agent Systems (IaC, CI/CD, Cloud) | drafted v1 | ch07-deployment.md |
| 8 | Context Engineering | drafted v1 | ch08-context-engineering.md |
| 9 | Memory Architecture | drafted v1 | ch09-memory-architecture.md |
| 10 | Enterprise RAG | drafted v1 | ch10-enterprise-rag.md |
| 11 | Knowledge Graphs & Graph RAG | drafted v1 | ch11-knowledge-graphs.md |
| 12 | Agentic Retrieval & Knowledge Routing | drafted v1 | ch12-knowledge-routing.md |
| 13 | Tools & Function Calling | drafted v1 | ch13-tools-function-calling.md |
| 14 | MCP, A2A & Agent Protocol Stack | drafted v1 | ch14-mcp-protocol-stack.md |
| 15 | Multi-Agent Systems | drafted v1 | ch15-multi-agent.md |
| 16 | Agent Observability | drafted v1 | ch16-observability.md |
| 17 | Evals | drafted v1 | ch17-evals.md |
| 18 | Reliability & Cost Engineering | drafted v1 | ch18-reliability-cost.md |
| 19 | Security & Guardrails | drafted v1 | ch19-security-guardrails.md |
| 20 | Autonomy, HITL & Governance | drafted v1 | ch20-autonomy-governance.md |
| 21 | Reference Architecture (capstone) | drafted v1 | ch21-reference-architecture.md |
| 22 | Interview Q&A Bank (companion) | drafted v1 | ch22-interview-qa.md |
| 23 | End-to-End Case Studies (companion) | drafted v1 | ch23-case-study.md |

*Status meanings: "drafted v1" = full chapter written, ready for deep-dive discussion together; "reviewed" = we discussed and refined it; "done" = labs completed too. Lab code goes in `labs/chNN-*/`.*
